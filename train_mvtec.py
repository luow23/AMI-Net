...
class Model(object):
    def __init__(self, opt):
        ...
        self.save_root = f"./result/{opt.model_name}_{opt.backbone_name}_k={opt.k}_cnum={opt.center_num}_sigma={opt.sigma}_inpaint_num={opt. in_lay_num}_clu_num={opt.clu_lay_num}_AvgTure_noise_scale20"       # os.makedirs(os.path.join(self.save_root, "weight"), exist_ok=True)
...
#
MVTec_CLASS_NAMES = ['transistor', 'cable', 'capsule', 'carpet', 'grid',
